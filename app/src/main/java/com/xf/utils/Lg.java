...
public class Lg {
    ...
    private static String LOG_TAG = "SofaVr"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + context.getApplicationContext().getPackageName();
        LOG_FILE_NAME = "Log";
    }
...
//            }
            ...
            if (className.contains("Lg")) {
                continue;
            }
            if (className.contains("Activity") || className.contains("Fragment") || className.contains("com.multi.school")) {
                return "[" + className + "]";
            }
